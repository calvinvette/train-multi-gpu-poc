...
# TODO - fix the login issue - requiring auth in the middle of a script is horrible
...
# TODO - conditionally create the project (re-entrant)
...
# TODO - conditionally create the service account (re-entrant)
...
# TODO - conditionally create the group (re-entrant)
echo "Creating group..."
...
echo "Group (Parent) ID: $GROUP"
echo "Resource (Project) ID: $PROJECT_ID"
# We keep getting access denied on this access-permit
